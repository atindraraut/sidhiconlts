...
router.post("/getCsv", (req, res) => {
  ...
  let queryExc = `SELECT awb,length,dead_weight,breadth,height,cloudStatus,scanned_date,scanned_time,cloudApiMsg,s3path,profiler_name FROM parcel_data where createdAt between '${parseDate(
    req.body.fromdate
